...
# Nem fog lefutni, mert az államoknak a neve nem jó formátumban van
plot_usmap(data = gdp2018 , regions = "state", values = "GDP", lines = "white") + 
  scale_fill_continuous(low = "lightred", high = "darkred", name = "GDP", label = scales::comma ) + 
  theme(legend.position = "right") +
  labs(title = "GDP államok szerint")
